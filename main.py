...
df = pd.read_csv("/root/.vscode-server/source_data/Cars - Cars.csv")
...
# Create app layout
app.layout = html.Div([
        html.H1("Prediction Of Car Price"),
        html.Br(),
        html.H3(" website."),
        html.Br(),
        html.H6("You may estimate the cost of the car by entering numbers into the parameters.The three elements that are interdependent in order to forecast vehicle pricing are"),
        html.H6("maximum force, mileage, and driving distance. To get results, you must first fill out at least one input field before clicking submit."),
        html.H6("Make sure not to fill the negative numbers below submit button."),
        html.Br(),
        html.H4("Derivation"),
        html.Br(),
        ...
        html.H6("Kilometers driven: the total distance by previous owner in km"),
        html.Br(),
